...
export class GetApi extends runtime.BaseAPI {
     ...
     */
    async getSpecialisationsRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<Department>>> {
        const queryParameters: any = {};
     ...
     * Get Specialisations List
     */
    async getSpecialisations(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Array<Department>> {
