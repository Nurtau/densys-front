...
import type { HTTPValidationError, Schedule } from "../models";
import {
...
export class ScheduleRegistrationApi extends runtime.BaseAPI {
  ...
  async createScheduleRaw(
    ...
    if (
      requestParameters.schedule === null ||
      requestParameters.schedule === undefined
    ) {
      throw new runtime.RequiredError(
        "schedule",
        "Required parameter requestParameters.schedule was null or undefined when calling createSchedule."
      );
    }
