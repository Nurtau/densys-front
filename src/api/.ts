...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
  users = {
    ...
    createPatient: (data: PatientCreate, params: RequestParams = {}) =>
      this.request<PatientPublic, HTTPValidationError>({
    ...
    getPatients: (params: RequestParams = {}) =>
      this.request<PatientPublic[], any>({
    ...
    updatePatient: (data: PatientCreate, params: RequestParams = {}) =>
      this.request<PatientInDB, HTTPValidationError>({
    ...
    updateDoctor: (data: DoctorCreate, params: RequestParams = {}) =>
      this.request<DoctorInDB, HTTPValidationError>({
    ...
    searchDoctors: (search: any, params: RequestParams = {}) =>
      this.request<DoctorPublic[], HTTPValidationError>({
    ...
    createAppointmentRequest: (data: AppointmentRequestCreate, params: RequestParams = {}) =>
      this.request<AppointmentRequestCreate, HTTPValidationError>({
    ...
    getActiveRequests: (params: RequestParams = {}) =>
      this.request<AppointmentRequestCreate[], any>({
    ...
    createSpecialisation: (data: Specialisation, params: RequestParams = {}) =>
      this.request<Specialisation, HTTPValidationError>({
    ...
    adminLogin: (data: AdminLogin, params: RequestParams = {}) =>
      this.request<AdminPublic, HTTPValidationError>({
        path: `/users/login`,
        method: "POST",
        body: data,
        type: ContentType.Json,
    ...
    createAdmin: (data: AdminCreate, params: RequestParams = {}) =>
      this.request<Admin, HTTPValidationError>({
    ...
    getSchedules: (doctorId: any, params: RequestParams = {}) =>
      this.request<DateRange[], HTTPValidationError>({
    ...
    login: (role: string, data: OthersLogin, params: RequestParams = {}) =>
      this.request<PatientPublic | DoctorPublic | (PatientPublic & DoctorPublic), HTTPValidationError>({
